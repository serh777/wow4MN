    ...
    <div className="space-y-6">
      <div className="mb-4">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          Problemas detectados y soluciones recomendadas para optimizar tu contenido
        </p>
      </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <Badge variant="outline" className="text-xs capitalize">
                        {diagnostic.category === 'seo' ? 'SEO' :
                         diagnostic.category === 'readability' ? 'Legibilidad' :
                         diagnostic.category === 'engagement' ? 'Engagement' : 'Técnico'}
                      </Badge>
                    </div>
                  </div>
                </div>
